...
describe('Trade', () => {
  ...
  const pair_wklay_0 = new Pair(
    new TokenAmount(WKLAY[ChainId.MAINNET], JSBI.BigInt(1000)),
  ...
  describe('#bestTradeExactIn', () => {
    ...
    it('works for KLAY currency input', () => {
      ...
      expect(result[0].route.path).toEqual([WKLAY[ChainId.MAINNET], token0, token1, token3])
      expect(result[0].outputAmount.currency).toEqual(token3)
      expect(result[1].inputAmount.currency).toEqual(KLAY)
      expect(result[1].route.path).toEqual([WKLAY[ChainId.MAINNET], token0, token3])
    ...
    it('works for KLAY currency output', () => {
      ...
      expect(result[0].route.path).toEqual([token3, token0, WKLAY[ChainId.MAINNET]])
      expect(result[0].outputAmount.currency).toEqual(KLAY)
      expect(result[1].inputAmount.currency).toEqual(token3)
      expect(result[1].route.path).toEqual([token3, token1, token0, WKLAY[ChainId.MAINNET]])
