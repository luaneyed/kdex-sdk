...
var WKLAY = (_WKLAY = {}, _WKLAY[exports.ChainId.CYPRESS] = /*#__PURE__*/new Token(exports.ChainId.CYPRESS, '0xecDC29C1A9C286C771686301554C219D4dDaA93e', 18, 'WKLAY', 'Wrapped KLAY'), _WKLAY[exports.ChainId.BAOBAB] = /*#__PURE__*/new Token(exports.ChainId.BAOBAB, '0x7D6a947ee257188298E34e0E9F619b5Dc4b24ba6', 18, 'WKLAY', 'Wrapped KLAY'), _WKLAY);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === KLAY && pairs[0].involvesToken(WKLAY[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === KLAY && pairs[pairs.length - 1].involvesToken(WKLAY[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === KLAY ? CurrencyAmount.klay(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === KLAY ? CurrencyAmount.klay(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(klayIn && klayOut) ?  invariant(false, 'KLAY_IN_OUT')  : void 0;
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.CYPRESS] = {
